...
[Releases](https://github.com/Lapius7/laping-lang/releases) から OS に対応するバイナリをダウンロードしてください。

- Linux: `laping-linux-x86_64`
- Windows: `laping-windows-x86_64.exe` と `libcurl-x64.dll`（**同じフォルダに両方を置いてください**。DLLが無いと起動できません）
